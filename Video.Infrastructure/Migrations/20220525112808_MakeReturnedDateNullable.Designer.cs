...
namespace Video.Infrastructure.Migrations
{
    ...
    [Migration("20220525112808_MakeReturnedDateNullable")]
    partial class MakeReturnedDateNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Video.Domain.Entities.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Video.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Video.Domain.Entities.Rental", b =>
                {
                    b.HasOne("Video.Domain.Entities.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Video.Domain.Entities.Movie", "Movie")
                        .WithMany()
